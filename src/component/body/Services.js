  ...
  return (
    <div className="bg-gradient-to-b from-negro to-negro1 text-white px-4 font-villa text-2xl lg:px-32">
      <div className="grid grid-cols-2 pt-5 md:grid-cols-3">
        ...
        <div data-aos="fade-up" className="grid justify-items-center pt-11">
          <div>
        ...
        <div data-aos="fade-up" className="grid justify-items-center pt-7 col-span-2 md:col-span-1 md:pt-11">
          <div className="">
            <img src={ecomer} alt="ecomerce" className="w-32 md:w-44"></img>
          </div>
          <div className="pt-4">Transporte E-commers</div>
        </div>
        <div data-aos="fade-up" className="grid justify-items-center pt-7 pb-5 col-span-2 md:col-span-3 md:pt-11">
          <div className="">
